...
import { addTaskTaskAC, changeTaskStatusTaskAC, removeTaskAC, tasksReducer, updateTaskTitleAC } from './tasksReducer';
import { AssocTaskType } from '../../App';
import { deleteTodoListAC, todoListReducer } from './todoListReducer';


// 1:33:15
const startsStateTasks: AssocTaskType = {
    'todolistID1': [
...
const  startsStateTodoLists: TodolistsType[]= [
